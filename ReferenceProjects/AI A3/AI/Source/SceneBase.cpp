...
void SceneBase::Init()
{
	...
	meshList[GEO_ALLY] = MeshBuilder::GenerateQuad("Ally", Color(1, 1, 1));
	meshList[GEO_ALLY]->textureID = LoadTGA("Image//Assignment3//Ally.tga");
	meshList[GEO_ENEMY] = MeshBuilder::GenerateQuad("Enemy", Color(1, 1, 1));
	meshList[GEO_ENEMY]->textureID = LoadTGA("Image//Assignment3//Enemy.tga");

	meshList[GEO_LINE] = MeshBuilder::GenerateLine("Line", Color(0, 1, 0), 1);
	meshList[GEO_SPHERE] = MeshBuilder::GenerateSphere("sphere", Color(0, 0, 0), 10, 10, 1.f);


	meshList[GEO_TOWER_ALLY] = MeshBuilder::GenerateSphere("TA", Color(0, 1, 0), 10, 10, 1.f);
	meshList[GEO_TOWER_ENEMY] = MeshBuilder::GenerateSphere("TE", Color(1, 0, 0), 10, 10, 1.f);
