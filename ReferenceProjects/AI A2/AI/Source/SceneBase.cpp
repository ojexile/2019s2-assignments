...
void SceneBase::Init()
{
	...
	meshList[GEO_FISH_TOOFULL] = MeshBuilder::GenerateQuad("FishTooFull", Color(1, 1, 1));
	meshList[GEO_FISH_TOOFULL]->textureID = LoadTGA("Image//toofull.tga");
	meshList[GEO_FISH_DEAD] = MeshBuilder::GenerateQuad("FishDead", Color(1, 1, 1));
	meshList[GEO_FISH_DEAD]->textureID = LoadTGA("Image//dead.tga");
	meshList[GEO_FISH_FULL] = MeshBuilder::GenerateQuad("FishFull", Color(1, 1, 1));
	meshList[GEO_FISH_FULL]->textureID = LoadTGA("Image//full.tga");
	meshList[GEO_FISH_HUNGRY] = MeshBuilder::GenerateQuad("FishHungry", Color(1, 1, 1));
	...
	meshList[GEO_SHARK_HAPPY] = MeshBuilder::GenerateQuad("sharkHappy", Color(1, 1, 1));
	meshList[GEO_SHARK_HAPPY]->textureID = LoadTGA("Image//happy.tga");
	meshList[GEO_SHARK_CRAZY] = MeshBuilder::GenerateQuad("sharkCrazy", Color(1, 1, 1));
	...
	meshList[GEO_HARVESTER_ATTACKED] = MeshBuilder::GenerateQuad("HarvesterAttack", Color(1, 1, 1));
	meshList[GEO_HARVESTER_ATTACKED]->textureID = LoadTGA("Image//Assignment1//Harvester_Attacked.tga");
	meshList[GEO_HARVESTER_DESTROYED] = MeshBuilder::GenerateQuad("HarvesterDestroyed", Color(1, 1, 1));
	meshList[GEO_HARVESTER_DESTROYED]->textureID = LoadTGA("Image//Assignment1//Harvester_Destroyed.tga");
	meshList[GEO_HARVESTER_HARVESTING] = MeshBuilder::GenerateQuad("HarvesterHarvesting", Color(1, 1, 1));
	meshList[GEO_HARVESTER_HARVESTING]->textureID = LoadTGA("Image//Assignment1//Harvester_Harvesting.tga");
	...
	meshList[GEO_FRIENDLYBULLET] = MeshBuilder::GenerateQuad("FriendlyBullet", Color(1, 1, 1));
	meshList[GEO_FRIENDLYBULLET]->textureID = LoadTGA("Image//Assignment1//FriendlyBullet.tga");
	...
	meshList[GEO_GRAYQUAD] = MeshBuilder::GenerateQuad("GrayQuad", Color(0.5f, 0.5f, 0.5f));
	meshList[GEO_REDQUAD] = MeshBuilder::GenerateQuad("GrayQuad", Color(1, 0, 0));
	meshList[GEO_QUEEN] = MeshBuilder::GenerateQuad("Queen", Color(1, 1, 1));
	meshList[GEO_QUEEN]->textureID = LoadTGA("Image//queen.tga");

	//Assignment 2
	meshList[GEO_PATH] = MeshBuilder::GenerateQuad("Path", Color(1, 1, 1));
	meshList[GEO_PATH]->textureID = LoadTGA("Image//Assignment2//Path.tga");
	meshList[GEO_WALL] = MeshBuilder::GenerateQuad("Wall", Color(1, 1, 1));
	meshList[GEO_WALL]->textureID = LoadTGA("Image//Assignment2//Wall.tga");
	meshList[GEO_WATER] = MeshBuilder::GenerateQuad("Water", Color(1, 1, 1));
	meshList[GEO_WATER]->textureID = LoadTGA("Image//Assignment2//Water.tga");
	meshList[GEO_TALL_GRASS] = MeshBuilder::GenerateQuad("TallGrass", Color(1, 1, 1));
	meshList[GEO_TALL_GRASS]->textureID = LoadTGA("Image//Assignment2//TallGrass.tga");
	meshList[GEO_ATTACK] = MeshBuilder::GenerateQuad("Attack", Color(1, 1, 1));
	meshList[GEO_ATTACK]->textureID = LoadTGA("Image//Assignment2//Attack.tga");
	meshList[GEO_ORAN_BERRY] = MeshBuilder::GenerateQuad("OranBerry", Color(1, 1, 1));
	meshList[GEO_ORAN_BERRY]->textureID = LoadTGA("Image//Assignment2//OranBerry.tga");
	meshList[GEO_STAIRS] = MeshBuilder::GenerateQuad("Stairs", Color(1, 1, 1));
	meshList[GEO_STAIRS]->textureID = LoadTGA("Image//Assignment2//Stairs.tga");
	meshList[GEO_FIRE] = MeshBuilder::GenerateQuad("FireTile", Color(1, 1, 1));
	meshList[GEO_FIRE]->textureID = LoadTGA("Image//Assignment2//Fire.tga");
	meshList[GEO_LOCKED_STAIRS] = MeshBuilder::GenerateQuad("LockedStairs", Color(1, 1, 1));
	meshList[GEO_LOCKED_STAIRS]->textureID = LoadTGA("Image//Assignment2//LockedStairs.tga");
	meshList[GEO_KEY] = MeshBuilder::GenerateQuad("Key", Color(1, 1, 1));
	meshList[GEO_KEY]->textureID = LoadTGA("Image//Assignment2//Key.tga");
	meshList[GEO_JIRACHI] = MeshBuilder::GenerateQuad("Jirachi", Color(1, 1, 1));
	meshList[GEO_JIRACHI]->textureID = LoadTGA("Image//Assignment2//Jirachi.tga");
	meshList[GEO_ENEMY_BULBASAUR] = MeshBuilder::GenerateQuad("Bulbasaur", Color(1, 1, 1));
	meshList[GEO_ENEMY_BULBASAUR]->textureID = LoadTGA("Image//Assignment2//Bulbasaur.tga");
	meshList[GEO_ENEMY_ABSOL] = MeshBuilder::GenerateQuad("Absol", Color(1, 1, 1));
	meshList[GEO_ENEMY_ABSOL]->textureID = LoadTGA("Image//Assignment2//Absol.tga");
	meshList[GEO_ENEMY_FLYGON] = MeshBuilder::GenerateQuad("Flygon", Color(1, 1, 1));
	meshList[GEO_ENEMY_FLYGON]->textureID = LoadTGA("Image//Assignment2//Flygon.tga");
