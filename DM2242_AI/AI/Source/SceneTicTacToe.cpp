...
int SceneTicTacToe::GetAIDecision(WHO_CONTENT type)
{
	int bestVal = -1000;
	int bestMove = -1;
...
int SceneTicTacToe::minimax(WHO_CONTENT type, bool isMax)
{
	//Win
	if (checkWin() == type)
		return 10;
...
SceneTicTacToe::WHO_CONTENT SceneTicTacToe::checkWin()
{
	for (int i = 0; i < 3; ++i) 
	{
		//Horizontal
