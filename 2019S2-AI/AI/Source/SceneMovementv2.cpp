...
SceneMovementv2::SceneMovementv2()
{
}
...
GameObject* SceneMovementv2::FetchGO()
{
...
void SceneMovementv2::Update(double dt)
{
	SceneBase::Update(dt);
...
void SceneMovementv2::RenderGO(GameObject *go)
{
	switch(go->type)
	{
